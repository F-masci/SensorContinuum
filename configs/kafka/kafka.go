...
// PROXIMITY_FOG_HUB_REALTIME_DATA_TOPIC permette la comunicazione tra il proximity fog hub e l'intermediate fog hub per lo scambio dei dati.
const PROXIMITY_FOG_HUB_REALTIME_DATA_TOPIC = "aggregated-data-proximity-fog-hub"
...
// PROXIMITY_FOG_HUB_AGGREGATED_STATS_TOPIC trasporta le statistiche aggregate (min, max, media)
...
const PROXIMITY_FOG_HUB_AGGREGATED_STATS_TOPIC = "statistics-data-proximity-fog-hub"

// PROXIMITY_FOG_HUB_HEARTBEAT_TOPIC permette la comunicazione tra il proximity fog hub e l'intermediate fog hub per lo scambio dei messaggi di heartbeat.
const PROXIMITY_FOG_HUB_HEARTBEAT_TOPIC = "heartbeats-proximity-fog-hub"
